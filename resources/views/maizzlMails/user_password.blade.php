            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  <table align="center" style="margin: 0 auto" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <a class="sm-p-6" href="https://lionsgeek.ma" style="padding: 20px 36px">
                        <img width="90" alt="LionsGeek" src="images/logo1.png" style="max-width: 100%; vertical-align: middle">
                      </a>
                    </tr>
                  </table>
                  <div role="separator" style="line-height: 24px">&zwj;</div>
                  ...
                  <p style="margin: 0 0 8px; font-size: 16px; line-height: 24px; color: #475569">
                    Welcome to My Lionsgeek! We’re excited to have you as part of
                    our community.
                  </p>
                  <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                    To get started, please set your password by clicking the link
                    below:
                  </p>
                  <div>
                    <a href="{{ $link }}" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; background-color: #020617" class="hover-bg-slate-800">
                  ...
                  <p style="margin: 16px 0 8px; font-size: 16px; line-height: 24px; color: #475569">
                    Once you’ve set your password, you’ll be able to access all
                  ...
                  <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569">
                    ...
                    <br>
                    <span style="font-weight: 600">Lionsgeek</span>
                  </p>
              ...
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px">
                  <p style="margin: 0; font-size: 12px; color: #64748b">
                    &copy; 2025 Lionsgeek. All rights
                    reserved.
                  </p>
                </td>
              </tr>
