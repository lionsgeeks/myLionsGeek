<div class="p-6 ml-24">
    <h1 class="text-xl font-bold text-alpha border-b pb-2 mb-4">Edit User</h1>
    <form wire:submit.prevent='save' class="space-y-4 flex flex-col gap-8">
        <div class="flex gap-5">
            <div>
                ...
                <input type="text" wire:model='userForm.name' placeholder="Enter full name"
                    class="w-[40vw] border border-gray-600 rounded-lg p-2 bg-gray-800 text-white focus:ring-2 focus:ring-alpha focus:outline-none">
                @error('userForm.name')
        ...
        <div class="mt-6 flex justify-end mr-36">
            <button type="submit"
                class="px-6 py-2 bg-alpha text-black font-semibold rounded-lg hover:bg-yellow-400 transition duration-300">
                Update
            </button>
        </div>
    </form>
