    ...
    <div class=" min-h-screen bg-black text-white">
        <nav class="px-14 py-4 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <h1 class=" text-xl lp:text-[20px] m-0 font-plusB ">Lions<span class="text-[#fee814]">Geek</span></h1>
            </div>
            <div class="flex gap-4 tes">
                <a href="{{ route('login') }}"
                    class="rounded-md px-3 py-1 text-black bg-[#fee814] ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                    Log in
                </a>
            </div>
        </nav>
        ...
        <div class="flex justify-center gap-[12vw] items-center pt-20">
            <div class="w-[40%]">
                ...
                <button
                    class="px-8 py-4 bg-[#fee814] text-black rounded-lg font-medium hover:bg-green-500 transition-colors flex items-center justify-center gap-2">
                    Browse Spaces
        ...
        <div class="flex justify-center items-center gap-[5rem] py-16  ">
            <div class="border py-10 px-36 border-gray-300 rounded-lg">
                <div class="flex items-center gap-4 mb-2">
                    <i class="fas fa-users text-xl text-[#fee814]"></i>
            ...
            <div class="border py-10 px-36 border-gray-300 rounded-lg">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fa-solid fa-grip text-2xl text-[#fee814]"></i>
            ...
            <div class="border py-10 px-36 border-gray-300 rounded-lg">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fa-solid fa-star text-xl text-[#fee814]"></i>
        ...
        <div class="grid grid-cols-2 px-24 py-20 gap-4 ">
            <div class="bg-[#101010] p-6 rounded-2xl">
                <i class=" fa-solid fa-microphone text-[#fee814] text-3xl mb-4"></i>
            ...
            <div class="bg-[#101010] p-6 rounded-2xl">
                <i class=" fa-solid fa-camera w-8 h-8 text-[#fee814] text-3xl mb-4"></i>
            ...
            <div class="bg-[#101010] p-6 rounded-2xl">
                <i class=" fa-solid fa-desktop w-8 h-8 text-[#fee814] text-3xl mb-4"></i>
            ...
            <div class="bg-[#101010] p-6 rounded-2xl">
                <i class=" fa-solid fa-video w-8 h-8 text-[#fee814] text-3xl mb-4"></i>
        ...
        <div class="py-20 px-24 border-t border-gray-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-[#101010] rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div>
                            <a href=""
                                class="px-4 py-2 bg-[#fee814]/10 text-[#fee814] rounded-lg hover:bg-[#fee814]/20 transition-colors">
                                Book Now
                            </a>
                        </div>
                    </div>
