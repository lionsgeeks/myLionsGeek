        ...
        <div className="min-h-screen bg-[#171717] text-white">
            ...
            <nav className="px-20 py-4 flex items-center justify-between">
                <div className="flex items-center">
                    <div className="mr-2">
                        <img src="https://mylionsgeek.ma/logo1.png" alt="logo" className="w-[22px] h-[22px] invert" loading="lazy"/>
                    </div>
                    <h1 className="text-xl lp:text-[20px] m-0 font-plusB ">Lions<span className="text-[#fee814]">Geek</span>
                    </h1>
                </div>
                <div className="">
                    <a href="/login" className="rounded-md px-4 py-2 text-black bg-[#fee814] ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                        Log in
                    </a>
                </div>
            </nav>
            ...
            <div className="flex justify-center gap-[12vw] items-center pt-20">
                <div className="w-[40%]">
                    ...
                    <button className="px-8 py-4 bg-[#fee814] text-black rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
                        Browse Spaces
            ...
            <div className="flex justify-center items-center gap-[6rem] py-16">
                <div className="border py-10 px-36 border-gray-300 rounded-lg">
                    <div className="flex items-center gap-4 mb-2">
                        <i className="fas fa-users text-xl text-[#fee814]"></i>
                ...
                <div className="border py-10 px-36 border-gray-300 rounded-lg">
                    <div className="flex items-center gap-4 mb-2">
                        <i className="fa-solid fa-grip text-2xl text-[#fee814]"></i>
                ...
                <div className="border py-10 px-36 border-gray-300 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                        <i className="fa-solid fa-star text-xl text-[#fee814]"></i>
            ...
            <div className="grid grid-cols-2 px-20 py-20 gap-4">
                <div className=" p-6 rounded-2xl bg-[#232323]">
                    <i className="fa-solid fa-microphone text-[#fee814] text-3xl mb-4"></i>
                ...
                <div className=" p-6 rounded-2xl bg-[#232323]">
                    <i className="fa-solid fa-camera text-[#fee814] text-3xl mb-4"></i>
                ...
                <div className=" p-6 rounded-2xl bg-[#232323]">
                    <i className="fa-solid fa-desktop text-[#fee814] text-3xl mb-4"></i>
                ...
                <div className=" p-6 rounded-2xl bg-[#232323]">
                    <i className="fa-solid fa-video text-[#fee814] text-3xl mb-4"></i>
            ...
            <div className="py-20 px-20 border-t border-gray-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className=" rounded-2xl overflow-hidden">
                        ...
                        <div className="py-6 px-2">
                            ...
                            <div>
                                <a href="#" className="px-4 py-3 bg-[#fee814]/10 text-[#fee814] rounded-lg hover:bg-[#fee814]/20 transition-colors">
                                    Book Now
                                </a>
                            </div>
                        </div>
